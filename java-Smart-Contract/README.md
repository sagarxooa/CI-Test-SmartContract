# Xooa Java Smart Contract

This page provides an overview to Xooa Java Smart Contract functionalities written.
...
## Deploy the Xooa Java Smart Contract 
 
1. Follow the instructions here: https://docs.xooa.com/start.html#deploy-the-smart-contract-app, selecting the **Xooa Java Smart Contract** as the smart contract.
...
## Explore the Xooa Java Smart Contract end-points
